//==============================================================================================
//
//   interp/exec - Statements in the oracle
//
//   DESCRIPTION:
//       Executes a checked function body: bindings, assignment, branches, loops, labeled
//       exits, `return`, `defer`/`errdefer` in last-in-first-out order, and `with` scopes.
//
//==============================================================================================
